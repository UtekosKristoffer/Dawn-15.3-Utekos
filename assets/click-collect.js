...
function updateClickCollectSummary() {
  const listContainer = document.getElementById('ClickCollectSummaryContainer');
  const itemTemplate = document.getElementById('ClickCollectItemTemplate');
...
function initializeClickCollectLogicIfNeeded() {
  const ClickCollectListContainer = document.getElementById('ClickCollectSummaryContainer');
...
async function handleAddToCart(event) {
  ...
  try {
    ...
    if (selectedDelivery === 'collect') {
      ...
      const cartDrawerElement = document.querySelector('cart-drawer data-open-cart-drawer'); // Finn <cart-drawer> elementet
      if (cartDrawerElement instanceof HTMLElement) {
        const cartItemsInDrawer =
          cartDrawerElement.querySelector('cart-items') ||
          cartDrawerElement.querySelector('cart-drawer-items');
