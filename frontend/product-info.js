...
if (!customElements.get('product-preview-handler')) {
  customElements.define(
    ...
    const vaultVariantDataElement = this.querySelector('[data-product-variants-json]');
    if (vaultVariantDataElement) {
      this.#vaultVariantData = JSON.parse(vaultVariantDataElement.textContent);
     ;}
